...
//        System.out.println("getInternalNodeIdOfOsmNode :" + getInternalNodeIdOfOsmNode(64422));
    ...
    protected void processWay(ReaderWay way) {
        ...
        System.out.println("osmNodeIds:" + osmNodeIds);//osm中node id
        ...
        System.out.println("firstLat+firstLon :" + firstLat+","+firstLon);
        System.out.println("last:" + last);
        System.out.println("lastLat+lastLon :" + lastLat+","+lastLon);
        if (!Double.isNaN(firstLat) && !Double.isNaN(firstLon) && !Double.isNaN(lastLat) && !Double.isNaN(lastLon)) {
            double estimatedDist = distCalc.calcDist(firstLat, firstLon, lastLat, lastLon);
            // Add artificial tag for the estimated distance and center
            way.setTag("estimated_distance", estimatedDist);
            System.out.println("estimatedDist:" + estimatedDist);
