...
public class Batch_Merge_search_withoutspeed {
    ...
    private static void search_rank(GraphHopper hopper_foot, GraphHopper hopper_car) throws IOException {
        ...
        while((line=reader.readLine())!=null) {
            ...
            Batch_Merge_search_withoutspeed example = new Batch_Merge_search_withoutspeed();
...
//            }
                File newcsv = new File("D://trj_test/24_our_withspeed.csv");
