...
public class Batch_Merge_search_withspeed {
...
//        BufferedReader reader = new BufferedReader(new FileReader("D://reason_order24_30/24_order_file.csv"));//换成你的文件名
        ...
        while((line=reader.readLine())!=null) {
            ...
            Batch_Merge_search_withspeed example = new Batch_Merge_search_withspeed();
...
//                File newcsv = new File("D://trj_test/24_our_withspeed_shortest_update.csv");
                File newcsv = new File("D://trj_test/sim_update/sim10_12_our_withspeed_fastest.csv");
                BufferedWriter bw = new BufferedWriter(new FileWriter(newcsv, true));
                /*根据排序得到的index，输出最优的上车点规划路径*/
                for (int i = 0; i < 1; i++) {
                    bw.write(oid + ";" +item[8]+ ";" + query_lat + ";" + query_lng + ";" + query_dlat + ";" + query_dlng + ";" + distancelist.get(all_rankIndex[i]).getGid() + ";" + time_slot_string + ";" + week_string + ";" + weekend + ";" +
