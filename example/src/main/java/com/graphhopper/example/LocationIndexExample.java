...
public class LocationIndexExample {
    ...
    public static void graphhopperLocationIndex(String relDir) {
        ...
        hopper.setOSMFile(relDir + "core/files/chengdu.osm.pbf");
        ...
        Snap snap = index.findClosest(30.667438,104.059904, EdgeFilter.ALL_EDGES);
        EdgeIteratorState edge = snap.getClosestEdge();
        System.out.println("edge-name:" + edge.getName());//结果是西华门街
