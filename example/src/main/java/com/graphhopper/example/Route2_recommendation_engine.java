...
public class Route2_recommendation_engine {
    ...
    public static void routing(GraphHopper hopper_foot,GraphHopper hopper_car) throws IOException{
        ...
        BufferedReader reader = new BufferedReader(new FileReader("D://PyTest/pythonProject1/gps_routing_1101_head_WSG84.csv"));//换成你的文件名
        ...
        while (((line = reader.readLine()) != null) && ((line2 = reader2.readLine()) != null)) {
            ...
            //将规划好的距离数据写入csv
            bw.write(item_orderid + "," + item1+ "," + item2+ "," +midlon1_final+ "," +midlat1_final+ ","+item3+ ","+item4+ "," + distance_first_final+ ","+ distance_second_final+ "," + dis_final);
            bw.newLine();//换行
            bw.close();
