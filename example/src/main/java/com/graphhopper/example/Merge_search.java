...
//    List near_gidList = new ArrayList();
    List his_points_numList = new ArrayList();
    List his_points_numList_gid = new ArrayList();
    List his_trj_numList = new ArrayList();
//    List near_distanceList = new ArrayList();
//    List near_lngList= new ArrayList();
//    List near_latList= new ArrayList();
    Map gid_map = new HashMap();
    Map his_points_num_map = new HashMap();
    Map his_trj_num_map = new HashMap();

    public static void main(String[] args) {
        Merge_search example = new Merge_search();
//        String query_lng= "104.08149";
//        String query_lat= "30.66693";
//        String query_dlng= "104.064028";
//        String query_dlat= "30.662442";

        String query_lng= "104.059764";
        String query_lat= "30.675721";
        String query_dlng= "104.064028";
        String query_dlat= "30.662442";
        int time_slot = 68;
        int weekend = 0;
    ...
    public Map get_near_gid(String query_lng,String query_lat,String query_dlng,String query_dlat) {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password);
            ...
            while (rs.next()) {
                i++;
//                near_gidList.add(rs.getString("gid"));
//                near_lngList.add(rs.getString("lng"));
//                near_latList.add(rs.getString("lat"));
